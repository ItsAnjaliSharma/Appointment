        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/d1.png" height="40px"></a>
                </div>
                <!-- Cosllect the nav links, forms, and other content for toggling -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <br />
                                        <span class="help-block">By clicking Create my account,<br>
